...
HD_PWD='C:/Users/onyek/project_recreation/project_recreation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log safe_logic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source safe_logic.tcl -notrace
