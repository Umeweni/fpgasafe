...
HD_PWD='C:/Users/onyek/project_recreation/project_recreation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log safe_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source safe_logic.tcl
